...
- I have two virtual machines run at a time. Let one VM sudo tcpdump ether host 01:02:03:04:05:06 in order to catch a frame from the MAC address. I have another VM sudo ./spoof in order to send an Ethernet frame, and the destination mac address is the one one's.
